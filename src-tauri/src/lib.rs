...
fn build_main_menu<R: tauri::Runtime, M: Manager<R>>(
    ...
    #[cfg(target_os = "macos")]
    let app_settings = menu_item_with_shortcut(app, menu_shortcuts, menu_labels,
        "app.settings",
        "Settings…",
        true,
        Some("CmdOrCtrl+,"),
    ...
    let open_space = menu_item_with_shortcut(app, menu_shortcuts, menu_labels,
        "space.open",
        "Open Space…",
        true,
        Some("CmdOrCtrl+O"),
    )?;
    let create_space = menu_item_with_shortcut(app, menu_shortcuts, menu_labels,
        "space.create",
        "New Space…",
        true,
        Some("CmdOrCtrl+Shift+N"),
    )?;
    let close_space = menu_item_with_shortcut(app, menu_shortcuts, menu_labels,
        "space.close",
        "Close Space",
        space_open,
        None,
    )?;
    let reveal_space = menu_item_with_shortcut(app, menu_shortcuts, menu_labels,
        "space.reveal",
        "Show Space in Finder",
        true,
        None,
    )?;
    let open_space_settings = menu_item_with_shortcut(app, menu_shortcuts, menu_labels,
        "space.settings",
        "Space Settings…",
        true,
        None,
    )?;
    let sync_now = menu_item_with_shortcut(app, menu_shortcuts, menu_labels,
        "space.git_sync_now",
        "Sync Now",
        true,
        None,
    )?;
    let open_git_settings = menu_item_with_shortcut(app, menu_shortcuts, menu_labels,
        "space.git_settings",
        "Git Sync Settings…",
        true,
        None,
    )?;
    let new_note = menu_item_with_shortcut(app, menu_shortcuts, menu_labels,
        "file.new_note",
        "New Note",
        true,
        Some("CmdOrCtrl+N"),
    )?;
    let create_from_template = menu_item_with_shortcut(app, menu_shortcuts, menu_labels,
        "file.create_from_template",
        "Create From Template",
        true,
        Some("CmdOrCtrl+Shift+M"),
    )?;
    let open_daily_note = menu_item_with_shortcut(app, menu_shortcuts, menu_labels,
        "file.open_daily_note",
        "Open Daily Note",
        true,
        Some("CmdOrCtrl+Shift+D"),
    )?;
    let save_note = menu_item_with_shortcut(app, menu_shortcuts, menu_labels,
        "file.save_note",
        "Save",
        true,
        Some("CmdOrCtrl+S"),
    )?;
    let print_note = menu_item_with_shortcut(app, menu_shortcuts, menu_labels,  "file.print_note",
        "Print Note…",
        show_markdown_menu,
        None,
    )?;
    let close_tab = menu_item_with_shortcut(app, menu_shortcuts, menu_labels,
        "file.close_tab",
        "Close Tab",
        true,
        Some("CmdOrCtrl+W"),
    )?;
    let toggle_ai = menu_item_with_shortcut(app, menu_shortcuts, menu_labels,
        "ai.toggle",
        "Toggle AI Pane",
        true,
    ...
    let editor_underline = menu_item_with_shortcut(app, menu_shortcuts, menu_labels,
        "editor.underline",
        "Underline",
        true,
        None,
    )?;
    let editor_strikethrough = menu_item_with_shortcut(app, menu_shortcuts, menu_labels,
        "editor.strikethrough",
        "Strikethrough",
        true,
        None,
    )?;
    let editor_link_set = menu_item_with_shortcut(app, menu_shortcuts, menu_labels,
        "editor.link_set",
        "Insert/Edit Link…",
        true,
        None,
    )?;
    let editor_link_clear = menu_item_with_shortcut(app, menu_shortcuts, menu_labels,
        "editor.link_clear",
        "Remove Link",
        true,
        None,
    )?;
    let editor_heading_1 = menu_item_with_shortcut(app, menu_shortcuts, menu_labels,
        "editor.heading_1",
        "Heading 1",
        true,
        None,
    )?;
    let editor_heading_2 = menu_item_with_shortcut(app, menu_shortcuts, menu_labels,
        "editor.heading_2",
        "Heading 2",
        true,
        None,
    )?;
    let editor_heading_3 = menu_item_with_shortcut(app, menu_shortcuts, menu_labels,
        "editor.heading_3",
        "Heading 3",
        true,
        None,
    )?;
    let editor_collapse_all_headings = menu_item_with_shortcut(app, menu_shortcuts, menu_labels,
        "editor.collapse_all_headings",
        "Collapse All Headings",
        true,
        None,
    )?;
    let editor_expand_all_headings = menu_item_with_shortcut(app, menu_shortcuts, menu_labels,
        "editor.expand_all_headings",
        "Expand All Headings",
        true,
        None,
    )?;
    let editor_bullet_list = menu_item_with_shortcut(app, menu_shortcuts, menu_labels,
        "editor.bullet_list",
        "Bullet List",
        true,
        None,
    )?;
    let editor_numbered_list = menu_item_with_shortcut(app, menu_shortcuts, menu_labels,
        "editor.numbered_list",
        "Numbered List",
        true,
        None,
    )?;
    let editor_todo_list = menu_item_with_shortcut(app, menu_shortcuts, menu_labels,
        "editor.todo_list",
        "To-do List",
        true,
        None,
    ...
    let editor_code_block = menu_item_with_shortcut(app, menu_shortcuts, menu_labels,
        "editor.code_block",
        "Code Block",
        true,
        None,
    )?;
    let editor_mermaid_chart = menu_item_with_shortcut(app, menu_shortcuts, menu_labels,
    ...
    let editor_details_block = menu_item_with_shortcut(app, menu_shortcuts, menu_labels,
        "editor.details_block",
        "Details Block",
        true,
        None,
    )?;
    let editor_callout_info = menu_item_with_shortcut(app, menu_shortcuts, menu_labels,
        "editor.callout_info",
        "Info Callout",
        true,
        None,
    )?;
    let editor_callout_warning = menu_item_with_shortcut(app, menu_shortcuts, menu_labels,
        "editor.callout_warning",
        "Warning Callout",
        true,
        None,
    )?;
    let editor_callout_error = menu_item_with_shortcut(app, menu_shortcuts, menu_labels,
        "editor.callout_error",
        "Error Callout",
        true,
        None,
    )?;
    let editor_callout_success = menu_item_with_shortcut(app, menu_shortcuts, menu_labels,
        "editor.callout_success",
        "Success Callout",
        true,
        None,
    )?;
    let editor_callout_tip = menu_item_with_shortcut(app, menu_shortcuts, menu_labels,
        "editor.callout_tip",
        "Tip Callout",
        true,
        None,
    ...
    let editor_color_brown = menu_item_with_shortcut(app, menu_shortcuts, menu_labels,
        "editor.color_brown",
        "Brown",
        true,
        None,
    )?;
    let editor_color_orange = menu_item_with_shortcut(app, menu_shortcuts, menu_labels,
        "editor.color_orange",
        "Orange",
        true,
        None,
    )?;
    let editor_color_yellow = menu_item_with_shortcut(app, menu_shortcuts, menu_labels,
        "editor.color_yellow",
        "Yellow",
        true,
        None,
    )?;
    let editor_color_green = menu_item_with_shortcut(app, menu_shortcuts, menu_labels,
        "editor.color_green",
        "Green",
        true,
        None,
    ...
    let editor_color_purple = menu_item_with_shortcut(app, menu_shortcuts, menu_labels,
        "editor.color_purple",
        "Purple",
        true,
        None,
    ...
    let editor_color_clear = menu_item_with_shortcut(app, menu_shortcuts, menu_labels,
        "editor.color_clear",
        "Clear Color",
        true,
        None,
    )?;
    let editor_highlight_yellow = menu_item_with_shortcut(app, menu_shortcuts, menu_labels,
        "editor.highlight_yellow",
        "Yellow",
        true,
        None,
    )?;
    let editor_highlight_blue = menu_item_with_shortcut(app, menu_shortcuts, menu_labels,
        "editor.highlight_blue",
        "Blue",
        true,
        None,
    )?;
    let editor_highlight_green = menu_item_with_shortcut(app, menu_shortcuts, menu_labels,
        "editor.highlight_green",
        "Green",
        true,
        None,
    )?;
    let editor_highlight_red = menu_item_with_shortcut(app, menu_shortcuts, menu_labels,
        "editor.highlight_red",
        "Red",
        true,
        None,
    )?;
    let editor_highlight_clear = menu_item_with_shortcut(app, menu_shortcuts, menu_labels,
        "editor.highlight_clear",
        "Clear Highlight",
        true,
        None,
    )?;
    let attach_current_note = menu_item_with_shortcut(app, menu_shortcuts, menu_labels,
        "ai.attach_current_note",
        "Send Current Note to AI",
        true,
        Some("CmdOrCtrl+Alt+A"),
    )?;
    let attach_all_open_notes = menu_item_with_shortcut(app, menu_shortcuts, menu_labels,
        "ai.attach_all_open_notes",
        "Send All Open Notes to AI",
        true,
        Some("CmdOrCtrl+Alt+Shift+A"),
    )?;
    let open_ai_settings = menu_item_with_shortcut(app, menu_shortcuts, menu_labels,
        "ai.settings",
        "AI Settings…",
        true,
        None,
    ...
    let help_getting_started = menu_item_with_shortcut(app, menu_shortcuts, menu_labels,
        "help.getting_started",
        "Getting Started",
        space_open,
        None,
    )?;
    let help_welcome_note = menu_item_with_shortcut(app, menu_shortcuts, menu_labels,  "help.welcome_note",
        "Welcome Note",
        space_open,
        None,
    )?;
    let help_shortcuts = menu_item_with_shortcut(app, menu_shortcuts, menu_labels,  "help.shortcuts",
        "Keyboard Shortcuts…",
        true,
        None,
    )?;
    ...
    let help_menu = {
        ...
        for (group_index, group) in HELP_LINK_GROUPS.iter().enumerate() {
            ...
            for (id, label) in *group {
                let item = menu_item_with_shortcut(app, menu_shortcuts, menu_labels, id, label, true, None)?;

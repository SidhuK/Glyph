...
export const LIGHT_THEME_OPTIONS = [
	{
		id: "glyph-default",
		label: "Default",
		description: "Warm paper surfaces with editorial contrast.",
		preview: {
			badgeBackground: "#f3f2ee",
			badgeBorder: "#d6d4cd",
			badgeText: "#26231d",
			accent: "#26231d",
			surface: "#ffffff",
...
export const DARK_THEME_OPTIONS = [
	{
		...
		label: "Default",
		description: "Cool charcoal surfaces with off-white text.",
		preview: {
			badgeBackground: "#1e1e22",
			badgeBorder: "#2e2e34",
			badgeText: "#ececee",
			accent: "#ececee",
			surface: "#17171a",

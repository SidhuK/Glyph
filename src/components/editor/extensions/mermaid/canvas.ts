...
export const MERMAID_CANVAS_DEFAULT_WIDTH = 800;
export const MERMAID_CANVAS_DEFAULT_HEIGHT = 480;
export const MERMAID_CANVAS_MIN_ZOOM = 0.25;
export const MERMAID_CANVAS_MAX_ZOOM = 4;
export const MERMAID_CANVAS_ZOOM_STEP = 1.2;
export const MERMAID_CANVAS_FIT_INSET = 24;
export const MERMAID_CANVAS_KEYBOARD_PAN_STEP = 32;

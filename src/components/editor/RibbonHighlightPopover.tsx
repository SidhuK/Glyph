...
import { getTextHighlightButton } from "./ribbonButtonConfigs";

interface RibbonHighlightPopoverProps {
	editor: Editor;
	canEdit: boolean;
					...
					{button.options.map((option) => (
						<button
							...
							className={`editorColorSwatchButton ${
								button.activeHighlight === option.id ? "active" : ""
							}`}
							title={option.label}
						...
						>
							<span
								...
								style={{
									backgroundColor: `var(${option.swatchCssVar}, ${option.swatchFallback})`,
								}}
								aria-hidden
							/>
						</button>

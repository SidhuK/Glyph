...
const SETTINGS_SEARCH_ITEMS = [
	...
	},
	{
		...
		section: "Light theme",
		title: "Background",
		description: "Customize the default light theme background color.",
		keywords: ["theme", "color", "light", "background"],
	},
	{
		id: "appearance-light-foreground",
		tab: "appearance",
		section: "Light theme",
		title: "Foreground",
		description: "Customize the default light theme foreground color.",
		keywords: ["theme", "color", "light", "foreground", "text"],
	},
	{
		...
		section: "Dark theme",
		title: "Background",
		description: "Customize the default dark theme background color.",
		keywords: ["theme", "color", "dark", "background"],
	},
	{
		id: "appearance-dark-foreground",
		tab: "appearance",
		section: "Dark theme",
		title: "Foreground",
		description: "Customize the default dark theme foreground color.",
		keywords: ["theme", "color", "dark", "foreground", "text"],
	},
	{

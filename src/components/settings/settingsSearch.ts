...
export const SETTINGS_SEARCH_INDEX: SettingsSearchRecord[] = [
	...
	},
	{
		...
		section: "Theme",
		label: "Light Theme",
		description: "Choose the theme family used when Glyph is in light mode.",
		keywords: [
			"light theme",
			"glyph default",
			"notion",
	...
	},
	{
		...
		section: "Theme",
		label: "Dark Theme",
		description: "Choose the theme family used when Glyph is in dark mode.",
		keywords: [
			"dark theme",
			"glyph default dark",
			"obsidian",
	...
	},
	{
		...
		description:
			"Toggle the translucent treatment used by the app frame, sidebar, and AI panel.",
		keywords: [
			"translucent",
			"app",
			"sidebar",
	...
	},
	{
		...
		label: "Accent Color",
		description:
			"Set the accent used for highlights and focus styling in the Glyph default themes.",
		keywords: ["accent", "color", "palette", "highlight", "default theme"],
	},
	{
	...
	},
	{
		...
		section: "Typography",
		label: "UI Font Size",
		description: "Adjust the base interface text size used in Glyph.",
		keywords: ["font", "size", "scale", "ui", "interface", "readability"],
	},
	{
		...
		description: "Adjust the note editor and markdown preview text size.",
		keywords: ["font", "size", "editor", "markdown", "reading", "preview"],
	},
	{

---
title: Trial System
description: Understanding Glyph's 7-day free trial
---

Official Glyph binaries include a **7-day free trial** that starts automatically on first launch.
...
<Steps>
  <Step title="Trial starts automatically">
    Glyph detects it's the first launch and starts a 7-day timer.
  </Step>
  ...
  <Step title="Trial expires after 7 days">
...
The trial is exactly **7 days** from the moment you first launch an official build.

- **Start time**: Recorded on first launch
- **Expiry time**: Exactly 7 days later
...
After 7 days, the trial expires and:
...
This official build includes a 7-day free trial. After that,
...
<Warning>
Deleting or modifying this file may reset your trial state, but you won't get additional trial time. The trial period is tied to the original start time.
</Warning>
...
|------------|-------|------------------|
| Official Release | Yes (7 days) | Yes, after trial |
...
- **First install**: New 7-day trial starts

...
Use the context manifest to estimate token usage before sending, then compare that with Anthropic's current pricing in [Anthropic Console](https://console.anthropic.com) or Anthropic's pricing documentation.

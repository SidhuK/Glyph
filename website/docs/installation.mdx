---
title: Installation
description: Download and install Glyph on macOS. Get started with the 7-day free trial.
---

# Installation

Glyph is currently available for macOS. Official release binaries include a 7-day free trial, with optional license activation for continued use.
...
<CardGroup cols={2}>
  <Card title="GitHub Releases" icon="github" href="https://github.com/SidhuK/Glyph/releases">
    Download official binaries (free 7-day trial)
  </Card>
...
<Steps>
  <Step title="Welcome Screen">
    When you first open Glyph, the launch screen gives you the main actions right away:

    1. **Continue last space** - Jump back into your most recent folder
    2. **Open folder** - Use an existing folder of markdown files
    3. **Create space** - Start a new local folder for notes

    Recent spaces appear on the same screen, and the first in-app guidance shows up after you open a space.
  </Step>
...
Official release binaries include a **7-day free trial**:
...
<AccordionGroup>
  <Accordion title="Glyph won't open after download">
    Make sure you are opening the latest release from [GitHub Releases](https://github.com/SidhuK/Glyph/releases) and that the download completed successfully. If the app still will not open, try downloading it again and replacing the previous copy in Applications.
  </Accordion>
